...
//    fun loadProfile(): MutableList<Contact> {
//        return mutableListOf(
//            Contact("max", "123-456-7890", R.drawable.pp_01, Status("Habe Steinpilze abzugeben.")),
//        )
//    }

    private var profile = Profile("Max Mustermann", "666-555-4444", R.drawable.img_default)
    ...
    private val contactList = mutableListOf(
        Contact(
            ...
            "123-456-7890",
            R.drawable.img_f_4,
            Status("Habe Steinpilze abzugeben.")
        ),
        Contact("John Doe", "321-654-0987", R.drawable.img_m_1, null),
        Contact("Emily Johnson", "111-222-3333", R.drawable.img_f_1, null),
        Contact("Tom Brown", "555-666-7777", R.drawable.img_m_2, null),
        Contact("Sara Williams", "888-999-0000", R.drawable.img_f_2, null),
        Contact("Mike Davis", "246-135-7920", R.drawable.img_m_3, Status("Schönes Wetter heute!")),
        Contact("Lena Wilson", "654-987-3210", R.drawable.img_f_3, null),
        Contact("Daniel Taylor", "987-654-3210", R.drawable.img_m_4, null),
        Contact("Chris Miller", "444-555-6666", R.drawable.img_m_5, null),
        Contact("Sophia Adams", "333-444-5555", R.drawable.img_f_4, Status("Meine Katze ist verschwunden, hat sie jemand gesehen?")),
        Contact("Lucas Nelson", "111-999-8888", R.drawable.img_m_6, null),
        Contact("Nina Lewis", "777-888-9999", R.drawable.img_f_5, null),
        Contact("Eva Clark", "222-333-4444", R.drawable.img_f_7, null),
        Contact("Tim Scott", "555-444-3333", R.drawable.img_m_7, Status("Liege krank im Bett, nur Notfälle heute.")),
        Contact("Oliver King", "666-555-4444", R.drawable.img_m_8, null),
        Contact("Julia Hill", "777-666-5555", R.drawable.img_f_8, null),
        Contact("Max Allen", "888-777-6666", R.drawable.img_m_10, null),
        Contact("Laura Reed", "999-888-7777", R.drawable.img_f_9, null),
        Contact("John Hall", "000-999-8888", R.drawable.img_m_11, null),
        Contact("Lisa Baker", "111-000-9999", R.drawable.img_f_6, null)
    )
    ...
    private val chatList = listOf(
        ...
        Chat(
            contactList[5], mutableListOf(
                Message("Was gibt's zum Abendessen?", true),
                Message("Pizza.", false)
            )
        ),
        Chat(
            contactList[7], mutableListOf(
